						...
						<td class="product-remove-and-thumbnail">
							<?php
								...
								if ( ! $_product->is_visible() ) {
									echo medical_clinic_return_content($thumbnail);
								} else {
				...
				<td colspan="6" class="actions">
					...
					<?php if ( wc_coupons_enabled() ) { ?>
						<div class="coupon">
							...
							<label for="coupon_code"><?php esc_html_e( 'Coupon', 'medical-clinic' ); ?>:</label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'medical-clinic' ); ?>" /> <button type="submit" class="button" name="apply_coupon"><?php esc_html_e( 'Apply Coupon', 'medical-clinic' ); ?></button>
