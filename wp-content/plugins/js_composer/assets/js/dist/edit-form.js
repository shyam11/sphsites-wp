...
if (function($) {
        ...
        media.controller.VcCssSingleImage = media.controller.VcSingleImage.extend({
            ...
            getBorder: function() {
                ...
                style && color && this.attrs["border-width"] && this.attrs["border-width"].match(/^\d+\S+$/) ? (this.attrs.border = this.attrs["border-width"] + " " + style + " " + color, this.attrs["border-width"] = void 0) : _.each(["left", "right", "top", "bottom"], function(side) {
